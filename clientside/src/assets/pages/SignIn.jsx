...
function SignIn() {
    ...
    const handleSubmit = (event) => {
        ...
        // Validate the inputs
        const errors = validate();
        setErrors(errors); // Optional: log errors for debugging
    ...
    const validate = () => {
        ...
        if (!password) {
            ...
            error.password = "Password must be SecurePass123";
        }
        return error;
    };
    ...
    return (
        <div className="w-screen h-screen bg-gray-900 flex justify-center items-center">
            ...
            >
                ...
                <div className="flex items-center flex-col font-bold text-sm">
                    <p className="">Email : example@domain.com</p>
                    <p className="">Password : SecurePass123</p>
                </div>
